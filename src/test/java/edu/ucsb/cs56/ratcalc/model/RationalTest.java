...
public class RationalTest {
    ...
    @Test
    public void test_5_15_plus_r_20_25() {
        Rational r = r_20_25.plus(r_5_15);
    ...
    @Test
    public void test_r_3_7_plus_r_20_25() {
        Rational r = r_3_7.plus(r_20_25);
    ...
    @Test
    public void test_r_m5_m7_plus_r_1_m8() {
        Rational r_m5_m7 = new Rational(-5,-7);
        Rational r_1_m8 = new Rational(1,-8);
        Rational r = r_m5_m7.plus(r_1_m8);
        assertEquals("33/56",r.toString());
    }

    @Test
    public void test_r_5_15_sum_r_20_25() {
        Rational r = Rational.sum(r_5_15,r_20_25);
        assertEquals("17/15", r.toString());
    }

    @Test
    public void test_r_5_15_sum_r_3_7() {
        Rational r = Rational.sum(r_5_15,r_3_7);
        assertEquals("16/21",r.toString());
    }

    @Test
    public void test_r_3_7_sum_r_13_4() {
        Rational r = Rational.sum(r_3_7,r_13_4);
        assertEquals("103/28",r.toString());
    }

    @Test
    public void test_r_3_7_sum_r_20_25() {
        Rational r = Rational.sum(r_3_7,r_20_25);
        assertEquals("43/35",r.toString());
    }

    @Test
    public void test_r_m3_1_sum_r_1_m3() {
        Rational r_m3_1 = new Rational(-3,1);
        Rational r_1_m3 = new Rational(1,-3);
    ...
    @Test
    public void test_r_m5_m7_sum_r_1_m8() {
        Rational r_m5_m7 = new Rational(-5,-7);
        Rational r_1_m8 = new Rational(1,-8);
        Rational r = Rational.sum(r_m5_m7,r_1_m8);
        assertEquals("33/56",r.toString());
    }

    @Test
    public void test_r_5_15_minus_r_20_25() {
        Rational r = r_5_15.minus(r_20_25);
    ...
    @Test
    public void test_r_3_7_minus_r_20_25() {
        Rational r = r_3_7.minus(r_20_25);
    ...
    @Test
    public void test_r_m5_m7_minus_r_1_m8() {
        Rational r_m5_m7 = new Rational(-5,-7);
        Rational r_1_m8 = new Rational(1,-8);
        Rational r = r_m5_m7.minus(r_1_m8);
        assertEquals("47/56",r.toString());
    }

    @Test
    public void test_r_5_15_difference_r_20_25() {
        Rational r = Rational.difference(r_5_15,r_20_25);
        assertEquals("-7/15", r.toString());
    }

    @Test
    public void test_r_5_15_difference_r_3_7() {
        Rational r = Rational.difference(r_5_15,r_3_7);
        assertEquals("-2/21",r.toString());
    }

    @Test
    public void test_r_3_7_difference_r_13_4() {
        Rational r = Rational.difference(r_3_7,r_13_4);
        assertEquals("-79/28",r.toString());
    }

    @Test
    public void test_r_3_7_difference_r_20_25() {
        Rational r = Rational.difference(r_3_7,r_20_25);
        assertEquals("-13/35",r.toString());
    }

    @Test
    public void test_r_m3_1_difference_r_1_m3() {
        Rational r_m3_1 = new Rational(-3,1);
        Rational r_1_m3 = new Rational(1,-3);
    ...
    @Test
    public void test_r_m5_m7_difference_r_1_m8() {
        Rational r_m5_m7 = new Rational(-5,-7);
        Rational r_1_m8 = new Rational(1,-8);
        Rational r = Rational.difference(r_m5_m7,r_1_m8);
        assertEquals("47/56",r.toString());
    }

    @Test
    public void test_reciprocalOf_m10_m5() {
    ...
    @Test
    public void test_reciprocalOf_m5_6() {
    ...
    @Test
    public void test_reciprocalOf_7_m8() {
        Rational r = new Rational(7,-8);
        Rational r1 = r.reciprocalOf();
        assertEquals("-8/7",r1.toString());
    }

    @Test
    public void test_reciprocalOf_m10_3() {
        Rational r = new Rational(-10,3);
        Rational r1 = r.reciprocalOf();
        assertEquals("-3/10",r1.toString());
    }

    @Test
    public void test_r_5_15_dividedBy_r_20_25() {
        Rational r = r_5_15.dividedBy(r_20_25);
    ...
    @Test
    public void test_r_3_7_dividedBy_r_20_25() {
        Rational r = r_3_7.dividedBy(r_20_25);
        assertEquals("15/28",r.toString());
    }

    @Test
    public void test_r_m3_1_dividedBy_r_1_m3() {
        Rational r_m3_1 = new Rational(-3,1);
        Rational r_1_m3 = new Rational(1,-3);
    ...
    @Test
    public void test_r_m5_m7_dividedBy_r_1_m8() {
        Rational r_m5_m7 = new Rational(-5,-7);
        Rational r_1_m8 = new Rational(1,-8);
        Rational r = r_m5_m7.dividedBy(r_1_m8);
        assertEquals("-40/7",r.toString());
    }

    @Test
    public void test_r_5_15_quotient_r_20_25() {
        Rational r = Rational.quotient(r_5_15,r_20_25);
        assertEquals("5/12", r.toString());
    }

    @Test
    public void test_r_5_15_quotient_r_3_7() {
        Rational r = Rational.quotient(r_5_15,r_3_7);
        assertEquals("7/9",r.toString());
    }

    @Test
    public void test_r_3_7_quotient_r_13_4() {
    ...
    @Test
    public void test_r_m3_1_quotient_r_1_m3() {
        Rational r_m3_1 = new Rational(-3,1);
        Rational r_1_m3 = new Rational(1,-3);
    ...
    @Test
    public void test_r_m5_m7_quotient_r_1_m8() {
        Rational r_m5_m7 = new Rational(-5,-7);
        Rational r_1_m8 = new Rational(1,-8);
        Rational r = Rational.quotient(r_m5_m7,r_1_m8);
        assertEquals("-40/7",r.toString());
    }
